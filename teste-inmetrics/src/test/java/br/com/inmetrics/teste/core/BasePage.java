...
/********* TextField e TextArea ************/
	...
	public void escreverByXPath(String name_campo, String texto){
	...
	public void clicarBotaoByXPath(String element) {
		clicarBotao(By.xpath(element));
	}
	...
	public String obterValueElementoByXPath(String texto) {
	...
	public String obterTextoByXPath(String element) {
		return obterTexto(By.xpath(element));
	}
	...
	public void aguardarElementoClicavel(String valor) {
		WebDriverWait wait = new WebDriverWait(getDriver(), 10);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(valor)));
	}
	...
	public String getTextoPagina(String elemento) {
